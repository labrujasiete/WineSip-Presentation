...
| 8. Secondary aromas      | Create all Secondary aromas icons and widgets         | --   | 🟢Finished    | --       | --      | Cristian D.         |
...
| 12. TextFields verifications      | Change all for "CupertinoTextField"'s and set maxCharacter Length and disable special characters for each one.        | --   | 🟢Finished    | --       | --      | Cristian D.         |
...
| 4. LOAD ON SCROLL (PAGINATION)     | Load more item when scroll down (so far called pagination) on every list on the app, mainly on the "people tab screen"                | --     | 🟢Finished    | --        | --        | Cristian D.        |
